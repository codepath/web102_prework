...
const displayStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${(totalGames > 1) ? `${totalGames} games`: `${totalGames} game`}. Currently  ${(numberOfUnfundedGames > 1) ? `${numberOfUnfundedGames} games remain`: `${numberOfUnfundedGames} game remains`} unfunded. We need your help to fund these amazing games!`
