...
const displayStr =
  unfundedCount === 1
    ? `A total of $${raised.toLocaleString("en-US")} has been raised for 
${
  GAMES_JSON.length
} games. Currently, ${unfundedCount} game remains unfunded. We need your help to fund these 
amazing games!`
    : `A total of $${raised.toLocaleString("en-US")} has been raised for 
${
  GAMES_JSON.length
} games. Currently, ${unfundedCount} games remain unfunded. We need your help to fund these 
amazing games!`;
...
const [first, second, ...remaining] = sortedGames
// console.log(first)
// console.log(second)
let pf = document.createElement('p')
pf.innerHTML = first.name
firstGameContainer.appendChild(pf)

let ps = document.createElement('p')
ps.innerHTML = second.name
secondGameContainer.appendChild(ps)
...
//customizing
//display games that matches the users search value

const searchValue = document.querySelector("#searchGame")
