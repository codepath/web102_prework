...
function addGamesToPage(games) {
    ...
    const gameCard = document.createElement("div");
        ...
        const percentageAchieved = Math.floor((games[i].pledged / games[i].goal) * 100);
        ...
        gameCard.innerHTML = `
            ...
            <p>Goal Achieved: ${percentageAchieved}%</p>
        `;
...
// Use toLocaleString to add commas to the total pledged amount
const formattedTotalPledged = totalPledged.toLocaleString();

// create a string that explains the number of unfunded games using the ternary operator
const unfundedGamesString = numUnfundedGames === 0
  ? `All ${GAMES_JSON.length} games are funded, raising a total of $${formattedTotalPledged}.`
  : `Out of ${GAMES_JSON.length} games, ${numUnfundedGames} ${numUnfundedGames === 1 ? "is" : "are"} currently unfunded, raising a total of $${formattedTotalPledged}.`;
